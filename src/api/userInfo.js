...
function UserInfo() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get("https://api.lanyard.rest/v1/users/805390931640451072");
  ...
  const fetchWeather = () => {
    axios
      .get("https://api.openweathermap.org/data/2.5/weather?q=Lao%20Cai&appid=a601622a383aee1aea5573743d8e8875&units=metric&lang=vi")
      .then((response) => {
        ...
        <div className='md:flex gap-6 items-center'>
          ...
          <div className='text-gray-900 '>
            ...
            <div className='font-semibold text-justify'>
              Chào mọi người! Tui là Yuuta (<span className='text-cyan-800'>200x</span>), lập trình viên web tự học và là người chơi Minecraft. Với kiến thức tự học và các dự án thú vị, tui đang tìm kiếm cơ hội mới để
